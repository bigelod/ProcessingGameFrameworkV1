...
//This is a completely blank framework with no game objects, game logic, and default input configuration
//Check the "Example Games" folder to see the different ways to use this engine for various games (and Kinect input!)
...
//Global variables, you can change these in your game setup!
//=============================================================
