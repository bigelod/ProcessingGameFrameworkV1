...
String gameTitle = "FrameworkV1 - German Shephard [KINECT EDITION!]";
int targetFPS = 30; //Used for frames per second, if using Kinect don't go above 30FPS!
...
void gameSetup() {
  //Uncomment this line if you want to use Kinect input! For more info see KinectInput tab!
  KinectSetup(); //Prepare the Kinect for the game, also remember there is a KinectDraw(); code happening below too in GameDraw!
...
void gameDraw() {
  ...
  KinectDraw(); //Update the frame of Kinect input and draw preview window
}
